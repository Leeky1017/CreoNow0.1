...
# A0-08 任务已创建但未产出正式结论
$ ls openspec/changes/a0-08-backup-capability-decision/
# tasks.md（任务定义存在，正式结论文档尚未产出）
...
**就绪度标记**：⚠️ 部分就绪——UI 存在但后端闭环状态待 A0-08 正式结论

**v0.1 处置建议**：
- 引用 A0-08（#1035）正式核查结论确定最终处置。
- 若 A0-08 结论为"后端未闭环"，则 v0.1 应隐藏备份间隔设置或标注 Coming Soon。
- 发布文档应根据 A0-08 结论如实描述备份能力边界。
...
| 备份能力 | ⚠️ 部分就绪 | Settings UI 有备份间隔选项；后端闭环待 A0-08（#1035）结论 | 依 A0-08 结论处置（隐藏/Coming Soon） |
