...
- [x] 逐一对比 7 条关键路径与 25 个 E2E spec 文件
- [x] 标注覆盖状态：✅ 已覆盖 / ⚠️ 部分覆盖 / ❌ 未覆盖
...
- [x] 在 `05-e2e-testing-patterns.md` 末尾新增「关键路径 ↔ E2E 映射表」章节

### Task 2.2: 空洞处理决策

**映射验收标准**: AC-2

- [x] 对 ⚠️ 项逐一评估：是否补充 E2E，或标注由下层测试覆盖并说明理由
- [x] 若需补充 E2E，作为子任务单独执行
