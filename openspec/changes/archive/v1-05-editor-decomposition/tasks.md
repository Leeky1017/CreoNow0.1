...
- **触发**: v1-02 ✅ 已合并（2026-03-20）
- **影响评估**: v1-05 为纯结构重构（文件拆分，零行为变更），v1-02 新增的 primitive variant（pill / bento / compact / underline / icon-size）未被 editor 模块使用
...
✅ **STABLE** — v1-05 在上游 v1-01 + v1-02 正式验证后，所有 AC 无退化，度量零偏差。
