...
- [x] 确认 `AGENTS.md` §6.4 的 6 条必跑命令完整列表：
  1. `git diff --numstat`
  2. `git diff --check`
...
- [x] 创建 `scripts/review-audit.sh`，覆盖上述全部命令
- [x] `chmod +x scripts/review-audit.sh`

### Task 2.2: Agent 引用更新

**映射验收标准**: AC-3

- [x] 在 `creonow-audit.agent.md` 中引用该脚本

### Task 2.3: 文档同步

**映射验收标准**: AC-4

- [x] 更新 `07-test-command-and-ci-map.md` 第二阶段状态
