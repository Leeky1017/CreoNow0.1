...
- **GitHub Issue**: #1125（child issue；umbrella #1122）
...
| ID   | 标准                                                    |
| ---- | ------------------------------------------------------- |
| AC-1 | SettingsExport 与 ShortcutsPanel 有真实入口且可关闭回退 |
| AC-2 | Account 页的每个入口状态与实际能力一致，不再产生误导    |
| AC-3 | 相关入口具备 i18n / a11y / Storybook / 测试覆盖         |
| AC-4 | factsheet、spec 与 Settings 文案对齐                    |
