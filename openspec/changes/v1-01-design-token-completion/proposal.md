...
| @theme duration | 3 个 | 5 个（含 instant 50ms、slower 500ms） | ✅ 已达成 | `grep -c 'duration' apps/desktop/renderer/src/styles/main.css` |
| @theme typography 映射 | 0 组 | 14×4=56 条属性映射 | ✅ 已达成 | `grep -cE '\-\-text-.*-(size\|weight\|tracking\|leading)' apps/desktop/renderer/src/styles/main.css` |
