...
R6 基线因采样路径不一致（声称 `src/features/`，R3 命令实际用 `components/features/`）予以撤回。R7 统一口径为 R3 的 `apps/desktop/renderer/src/components/features/` 生产文件。

### R7 基线重采集

| 度量             | R3 基线 | R7 实际 | Delta | 说明                          |
| ---------------- | ------- | ------- | ----- | ----------------------------- |
| text-[           | 95      | 95      | 0     | v1-13 不涉及 arbitrary 值替换 |
| rounded-[        | 18      | 18      | 0     | 无变化                        |
| w-[]/h-[]        | 8       | 8       | 0     | 无变化                        |
| p-[]/m-[]/gap-[] | 1       | 1       | 0     | 无变化                        |
| shadow-[         | 7       | 7       | 0     | 无变化                        |
