...
v1-12 合并（PR #1213）后基线大幅下降。features 层 arbitrary values 从 228（R3）降至 ~61（R6），降幅 73%。v1-02 variant 采用从 0 爆增至 93（AC-4 已自动达成）。

v1-18 剩余工作量大幅缩减，详见 `proposal.md` R6 级联刷新记录。工作量预估从 ~2d 进一步降至 ~1d。
