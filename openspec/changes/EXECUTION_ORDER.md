...
| 状态                    | Change 数 | 列表                         | 级联状态                  |
| ----------------------- | --------- | ---------------------------- | ------------------------- |
| ✅ 已合并               | 15        | v1-01 ~ v1-12, v1-14 ~ v1-16 | 🔄 待级联刷新             |
...
> **v1-12 已合并（PR #1213）。** AppShell 1267→153 行，原生 HTML 102→0，eslint-disable 159→59。v1-13 阻断已解除，待启动。
...
| 13   | v1-13-eslint-disable-audit                  | 🟡 **已解除阻断，待启动** | v1-12 | 基线 229→59（-74%），审计范围缩窄至 32 处 non-primitive disable<br>→ 🔄 无直接下游需刷新                                     |
...
| Change | 需要                      | 原因                                                                      |
| ------ | ------------------------- | ------------------------------------------------------------------------- |
| v1-13  | 🟡 **已解除阻断，待启动** | eslint-disable 229→59（-74%），审计范围缩窄至 32 处 non-primitive disable |
