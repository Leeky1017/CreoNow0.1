  ...
  return (
    <div className="flex-1 overflow-y-auto flex">
        ...
        <div className="flex items-start justify-between mb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground text-base leading-relaxed max-w-lg">
              Your daily productivity metrics are stable. You have 3 active
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-16">
          ...
          >
            ...
            <div className="mt-12">
              ...
              <p className="text-[15px] text-muted-foreground leading-relaxed line-clamp-2 mb-6 max-w-md">
                Chapter 4 explores the latency issues in direct cortical
                stimulation. Currently at 4,200 words.
              </p>
              <div className="text-[11px] font-medium text-zinc-500 tracking-[0.2em]">
                EDITED 2H AGO
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-border/40 bg-[#0a0a0a] p-8 flex flex-col justify-between shadow-sm">
            ...
            <div className="mt-auto">
              <div className="text-5xl text-white mb-2 font-light tracking-tight">
                12k
              </div>
      ...
      <aside className="hidden xl:block w-[320px] border-l border-border/40 bg-black/20 p-8 shrink-0 overflow-y-auto">
        <div className="mb-12">
          <div className="text-[11px] font-medium tracking-[0.2em] text-muted-foreground mb-4">
            ACTIVE CONTEXT
          </div>
          <h3 className="text-lg font-medium text-white mb-6 leading-tight">
        ...
        <div>
          <div className="text-[11px] font-medium tracking-[0.2em] text-muted-foreground mb-6">
            HISTORY
          </div>
