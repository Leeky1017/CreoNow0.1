...
import { Search, Inbox, Clock, Settings, Plus, LayoutDashboard, Calendar, PieChart, BookOpen, Layers, PenTool, Hash, Type } from "lucide-react"
    ...
    <div className="flex h-screen w-64 flex-col border-r border-neutral-800/50 bg-[#000000] text-neutral-400 font-sans text-sm">
      <div className="p-6">
        <Link to="/dashboard" className="flex items-center gap-2 text-white hover:opacity-80 transition-opacity">
          <div className="flex h-6 w-6 items-center justify-center rounded bg-white text-black font-bold text-xs">C</div>
          <span className="font-semibold tracking-wide text-sm">CREO<span className="text-neutral-500">NOW</span></span>
        </Link>
      </div>
