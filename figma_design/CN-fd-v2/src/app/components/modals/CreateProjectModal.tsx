...
const PROJECT_TYPES = [
  ...
  {
    id: "Short Story",
    icon: <Scroll className="w-[16px] h-[16px]" />,
    label: "Short Story",
  },
  {
    id: "Screenplay",
    icon: <Clapperboard className="w-[16px] h-[16px]" />,
    label: "Screenplay",
  },
  {
    id: "Other",
    icon: <Layout className="w-[16px] h-[16px]" />,
    label: "Other",
  },
];
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-[24px] h-[48px] border-b border-[#2A2A2A] shrink-0 bg-[#111111]">
          <DialogTitle className="text-[14px] font-medium text-[#F0F0F0]">
            Create New Project
          </DialogTitle>
          <button
            onClick={() => onOpenChange(false)}
            className="text-[#888888] hover:text-[#F0F0F0] transition-colors duration-150"
          >
        ...
        <div className="p-[24px] space-y-[24px] overflow-y-auto max-h-[calc(85vh-100px)]">
          ...
          <div className="space-y-[8px]">
            ...
            <div className="border border-dashed border-[#2A2A2A] rounded-[8px] p-[24px] flex flex-col items-center justify-center text-center hover:bg-[#1E1E1E] hover:border-[#3A3A3A] transition-all duration-150 cursor-pointer min-h-[120px]">
              ...
              <span className="text-[12px] text-[#888888] mb-[4px]">
