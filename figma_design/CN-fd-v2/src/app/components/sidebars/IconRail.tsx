        ...
        <button
          ...
          className={cn(
            ...
            isActive
              ...
              : "text-[#888888] hover:text-[#CCCCCC] hover:bg-[#1E1E1E] focus-visible:text-[#CCCCCC] focus-visible:bg-[#1E1E1E] focus-visible:outline-2 focus-visible:outline-[#F0F0F0] focus-visible:outline-offset-2",
          )}
        >
