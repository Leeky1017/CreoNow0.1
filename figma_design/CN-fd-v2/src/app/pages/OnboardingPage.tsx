...
const options = [
  {
    ...
    title: "Agent 智能写作",
    icon: Brain,
    desc: "Agent-powered writing assistant",
  },
    ...
    <div className="flex h-screen w-full flex-col bg-[#0D0D0D] text-[#F0F0F0] items-center justify-center p-[32px] relative overflow-hidden font-sans">
      ...
      <div className="max-w-2xl w-full flex flex-col items-center space-y-[32px] relative z-10">
        ...
        <div className="text-center space-y-[8px]">
          <h1 className="text-[28px] font-bold text-[#F0F0F0] leading-[1.2] tracking-[-0.01em]">
            CreoNow
          </h1>
          <p className="text-[12px] text-[#888888] tracking-[0.05em] uppercase">
            Agent-Native Content Creation IDE
          </p>
        </div>
          ...
          {options.map((opt) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <div className="text-[14px] font-medium text-[#F0F0F0]">
                    {opt.title}
                  </div>
                  <div className="text-[12px] text-[#888888] mt-[4px]">
                    {opt.desc}
                  </div>
                </div>
              </button>
      ...
      <div className="absolute bottom-[40px] left-0 right-0 px-[48px] flex justify-between items-center">
        <div className="flex items-center gap-[24px] text-[12px] text-[#888888] tracking-[0.05em] uppercase">
          <button className="hover:text-[#F0F0F0] transition-colors duration-150">
            帮助
          </button>
          <button
            onClick={() => navigate("/app")}
            className="hover:text-[#F0F0F0] transition-colors duration-150"
          >
            跳过
          </button>
        </div>
