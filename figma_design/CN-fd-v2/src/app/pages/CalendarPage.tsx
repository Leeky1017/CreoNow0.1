...
const mockEvents: CalendarEvent[] = [
  ...
  },
  {
    ...
    title: "Auto-save Milestone (10k words)",
    type: "system",
    category: "creation",
  },
  {
        ...
        <div className="flex items-center gap-[16px]">
          ...
          <div className="flex items-center gap-[8px] bg-[#1A1A1A] border border-[#2A2A2A] rounded-[4px] px-[4px] py-[4px]">
            <button
              ...
              className="p-[4px] text-[#888888] hover:text-[#F0F0F0] hover:bg-[#1E1E1E] rounded-[4px] transition-colors duration-150"
            >
        ...
        <div className="border border-[#2A2A2A] rounded-[8px] overflow-hidden h-full flex flex-col">
          ...
          <div className="grid grid-cols-7 border-b border-[#2A2A2A] bg-[#1A1A1A] shrink-0">
            {["MON", "TUE", "WED", "THU", "FRI", "SAT", "SUN"].map((d) => (
              <div
                key={d}
                className="py-[8px] text-center text-[12px] font-medium text-[#888888] tracking-[0.05em] border-r border-[#2A2A2A] last:border-r-0"
              >
                {d}
              </div>
            ))}
