...
const dailyData = [
  { label: "6am", count: 0 },
  { label: "8am", count: 120 },
  { label: "10am", count: 800 },
  { label: "12pm", count: 400 },
  { label: "2pm", count: 600 },
  { label: "4pm", count: 350 },
  { label: "6pm", count: 180 },
  { label: "8pm", count: 0 },
...
const weeklyData = [
  { label: "Mon", count: 800 },
  { label: "Tue", count: 1200 },
  { label: "Wed", count: 3200 },
  { label: "Thu", count: 900 },
  { label: "Fri", count: 0 },
  { label: "Sat", count: 0 },
  { label: "Sun", count: 0 },
      ...
      <div className="max-w-[1120px] mx-auto px-[32px] pt-[40px] pb-[64px]">
        ...
        <div className="flex items-end justify-between mb-[32px]">
          <div>
            <motion.h1
              {...stagger(0)}
              className="text-[32px] font-bold text-[#F0F0F0] leading-[1.2] tracking-[-0.02em]"
            >
              Analytics
            </motion.h1>
            <motion.p
              {...stagger(0.5)}
              className="mt-[8px] text-[14px] text-[#555555] leading-[1.6]"
            >
          ...
          <motion.div
            {...stagger(1)}
            className="flex items-center bg-[#141414] border border-[#1E1E1E] rounded-[6px] p-[3px]"
          >
            {timeRanges.map((r) => (
              <button
                key={r}
          ...
          {kpis.map((kpi, i) => (
            ...
            >
              ...
              <div className="flex items-baseline gap-[6px] mt-[8px]">
                <span className="text-[32px] font-bold text-[#F0F0F0] leading-[1.1] tracking-[-0.02em]">
                  {kpi.value}
                </span>
                {kpi.unit && (
                  <span className="text-[12px] text-[#555555]">{kpi.unit}</span>
                )}
                <span
                  className={cn(
                    "text-[11px] font-medium leading-[1.2] ml-auto",
                    kpi.trendDir === "up"
                      ? "text-[#4ADE80]"
                      : kpi.trendDir === "down"
                        ? "text-[#F87171]"
              ...
              <div className="flex items-start gap-[6px] mt-[12px] pt-[12px] border-t border-[#1E1E1E]">
                ...
                <span className="text-[11px] text-[#555555] leading-[1.5] line-clamp-2">
                  {kpi.agent}
                </span>
              </div>
            </motion.div>
        ...
        <div className="grid grid-cols-2 gap-[16px] mb-[16px]">
          ...
          <motion.div
            {...stagger(5)}
            className="bg-[#141414] border border-[#1E1E1E] rounded-[12px] p-[20px] h-[300px] hover:border-[#2A2A2A] transition-colors duration-200"
          >
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={focusData}>
                  ...
                  <Area
                    ...
                    fill="url(#focusFill)"
                    dot={false}
                    activeDot={{ r: 3, fill: "#E0E0E0", strokeWidth: 0 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </div>
        ...
        <div className="grid grid-cols-2 gap-[16px]">
          ...
          <motion.div
            {...stagger(7)}
            className="bg-[#141414] border border-[#1E1E1E] rounded-[12px] p-[20px] h-[320px] hover:border-[#2A2A2A] transition-colors duration-200"
          >
            <h3 className="text-[14px] font-semibold text-[#F0F0F0] leading-[1.4] tracking-[0.01em] uppercase mb-[20px]">
              Project Distribution
            </h3>
            <div className="flex items-center gap-[24px]">
              <div className="w-[160px] h-[160px] shrink-0 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <span className="text-[24px] font-bold text-[#F0F0F0] leading-[1.2] tracking-[-0.02em]">
                    28.5h
                  </span>
          ...
          <motion.div
            {...stagger(8)}
            className="bg-[#141414] border border-[#1E1E1E] rounded-[12px] p-[20px] h-[320px] flex flex-col hover:border-[#2A2A2A] transition-colors duration-200"
          >
            ...
            <div className="flex-1 flex flex-col gap-[16px] overflow-y-auto">
              {agentSuggestions.map((s, i) => (
                ...
                >
                  ...
                  <p className="text-[13px] text-[#888888] leading-[1.65] line-clamp-3">
                    {s}
                  </p>
                </div>
              ))}
