...
- 创建并维护 `rulebook/tasks/archive/2026-02-25-issue-635-issue-606-phase-4-polish-and-delivery/`，作为本 issue 的执行与证据载体。
...
- Affected specs:
  - `openspec/changes/archive/issue-606-phase-4-polish-and-delivery/**`（仅依赖核对，未修改）
