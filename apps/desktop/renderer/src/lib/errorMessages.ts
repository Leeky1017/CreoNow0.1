...
> = {
  ...
  PREFLIGHT_INVALID_API_KEY_FORMAT: () =>
    t("error.code.PREFLIGHT_INVALID_API_KEY_FORMAT"),
  PREFLIGHT_MISSING_API_KEY: () => t("error.code.PREFLIGHT_MISSING_API_KEY"),
  PREFLIGHT_MISSING_MODEL: () => t("error.code.PREFLIGHT_MISSING_MODEL"),
  PREFLIGHT_MODEL_PROVIDER_MISMATCH: () =>
    t("error.code.PREFLIGHT_MODEL_PROVIDER_MISMATCH"),
